defmodule DrywWeb.AuthCase do
  ...
  This code is extracted from contactopensource/navatrack and is public domain.
  ...
  using do
    quote do
      ...
      def my_sign_in!(user) do
        ...
        # TODO carp
        {:ok, user} = AshAuthentication.Strategy.action(strategy, :sign_in, %{"token" => token})
        user
      end
    end
  end
